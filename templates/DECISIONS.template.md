...
<!-- Compact log for durable cross-cutting decisions. One row per decision,
...
<!-- Move a row here when a later decision replaces it; state the successor ID.
     Do not delete: a fresh agent must see why the direction changed. -->
