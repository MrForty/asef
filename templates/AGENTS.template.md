<!-- Copy the block below into the target project's `AGENTS.md`, `CLAUDE.md`
     or the equivalent file the agent reads on start. It activates ASEF in
     every session without pasting the prompt. Add no framework rules here:
